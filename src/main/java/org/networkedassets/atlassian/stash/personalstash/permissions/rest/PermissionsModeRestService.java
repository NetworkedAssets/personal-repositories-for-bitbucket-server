package org.networkedassets.atlassian.stash.personalstash.permissions.rest;
...
public class PermissionsModeRestService {
	...
	private org.networkedassets.atlassian.stash.personalstash.permissions.PermissionsMode parsePermissionModeParam(
			String mode) {
		if (mode.equalsIgnoreCase("deny")) {
			return org.networkedassets.atlassian.stash.personalstash.permissions.PermissionsMode.DENY;
		} else {
			return org.networkedassets.atlassian.stash.personalstash.permissions.PermissionsMode.ALLOW;
		}
	}

	private PermissionsMode createPermissionModeReponse(
			org.networkedassets.atlassian.stash.personalstash.permissions.PermissionsMode mode) {
